      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <img
              src="https://media.istockphoto.com/id/1154404179/it/vettoriale/icona-del-volante-e-design-piatto-dellombra.jpg?s=612x612&w=0&k=20&c=dXvOtLEXCAxiszd8lSG_iJlV4voC_IiIhd9UHG4dtpg="
              alt="Website Logo"
              className="w-8 h-8 mr-2 w-20 rounded-full"
            />
          ...
          <div className="flex">
            <div className="hidden sm:block">
              ...
              {user && (
                <button className="text-white" onClick={handleUserLogOut}>
                  Log Out
                </button>
              )}
            </div>
